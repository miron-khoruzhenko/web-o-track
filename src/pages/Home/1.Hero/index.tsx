			...
			<div className="max-w-[580px] mx-auto pt-4 ">
				...
				<div className="border-b border-black md:border-none pb-1 pl-2 ">
					...
					<p className="font-[Inter] mb-[4%] text-[8px] md:text-base ">
						It's not about ideas. It's about <span className="font-['Press_Start_2P'] ml-1 align-top text-[#F43A66]">making ideas happen</span>
					</p>
				</div>

				<div className="full hidden md:grid grid-cols-4 mt-[4%] text-[11px] text-center mb-[72px]">
				...
				<div className="">
					...
					<button className=" text-center mx-auto flex items-center justify-center gap-1 border-[2px] border-black bg-white p-4">
						<span className="text-xs tracking-tighter">Contact us today !</span> <img src={arrow_icon} alt="" className="invert" />
					</button>
				</div>
			</div>
