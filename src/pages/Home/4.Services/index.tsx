...
const Services = () => {
	return (
		<section className='relative pb-[94px]' id='services'>
			<div className="max-w-[580px] mx-auto relative z-10 ">
				...
				<div className="grid grid-cols-5 mb-[70px]">
					<div className="flex items-center justify-center col-span-2 bg-gradient-to-r from-[rgba(70,210,176,.35)] to-white">
						<img src={icon1} alt="" className="" />
					</div>
					<div className="col-span-3 pt-2 pb-4  ">
						<h3 className="mb-5">On-hands Approach</h3>
						<p className="font-medium text-[15px] font-[Inter]">Our team takes care of everything from strategy development to execution, ensuring maximum engagement and profitability for your project.</p>
					</div>
				</div>
				...
				<div className="grid grid-cols-5">
					<div className="col-span-3 pt-2 pb-4  ">
						...
						<p className="font-medium text-[15px] font-[Inter]">As a connector, we link your project with top KOLs, fostering strong relationships and achieving expansive impact quickly.</p>
					</div>
				...
				>
					<div
						...
						<h3 className="mb-4 text-[23px]">0 DIRECT cost</h3>
